...
<section className="relative overflow-hidden pt-8 pb-4 text-center z-0 flex flex-col justify-center min-h-[calc(100vh-4rem)]">
      ...
      <div className="absolute top-20 left-[10%] w-72 h-72 bg-indigo-400/10 rounded-full blur-[100px] animate-pulse" style={{ animationDuration: '8s' }}></div>
      <div className="absolute top-40 right-[15%] w-96 h-96 bg-violet-400/10 rounded-full blur-[120px] animate-pulse" style={{ animationDuration: '10s', animationDelay: '2s' }}></div>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <h1 className="animate-fade-up delay-100 text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-foreground max-w-4xl mx-auto leading-[1.08]">
          ...
          <span className="relative inline-block">
            ...
            <svg className="absolute -bottom-2 left-0 w-full h-3 text-indigo-200/60" viewBox="0 0 200 12" preserveAspectRatio="none">
      ...
      <div className="animate-fade-up delay-400 mt-12 max-w-6xl mx-auto px-4 sm:px-6 relative z-10 w-full">
        ...
        <div className="absolute -inset-4 rounded-[2.5rem] bg-gradient-to-b from-indigo-500/15 via-violet-500/10 to-transparent opacity-60 blur-3xl -z-10 animate-pulse" style={{ animationDuration: '6s' }}></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] min-h-[480px]">
            ...
            <div className="hidden md:block border-r border-border/40 bg-[#F8F9FA]/80 backdrop-blur-sm p-5">
              <div className="font-bold flex items-center gap-2.5 mb-10 mt-1">
                ...
                <span className="text-[15px] tracking-tight text-slate-800">ZenBoard</span>
              </div>
              ...
              <div className="space-y-8">
                <nav className="space-y-1">
                  <div className="flex justify-between items-center px-3 py-2.5 rounded-xl bg-slate-50 shadow-sm text-sm font-bold text-slate-800 border border-slate-100/80 ring-1 ring-slate-100/50">
                    ...
                    <span className="bg-slate-100 text-slate-600 text-[10px] font-bold px-1.5 py-0.5 rounded-md">16</span>
                  </div>
                ...
                <div>
                  <p className="text-[10px] font-bold text-slate-400 mb-3 px-3 tracking-widest uppercase">Workspace</p>
                  <nav className="space-y-0.5">
                    {['Dashboard', 'My Boards', 'Team Members', 'Settings'].map((item, i) => (
                      <div key={item} className="flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-medium text-slate-500 hover:bg-slate-50/60 hover:text-slate-700 transition-all cursor-pointer group">
                        <div className={`w-4 h-4 rounded-[4px] ${['bg-slate-200','bg-indigo-200','bg-emerald-200','bg-amber-200'][i]} group-hover:scale-110 transition-transform`}></div>
                        {item}
                      </div>
                    ))}
                  </nav>
            ...
            <div className="p-6 md:p-8 bg-slate-50 flex flex-col h-full overflow-hidden relative">
              ...
              <div className="flex justify-between items-start mb-8">
                <div>
                  <p className="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-1">Welcome back,</p>
                  <h4 className="font-extrabold text-xl text-slate-800 tracking-tight">Brooklyn Simmons</h4>
                </div>
                
                <div className="flex items-center gap-4">
                  <div className="flex -space-x-2.5">
                    <div className="w-9 h-9 rounded-full border-[2.5px] border-white bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-[11px] text-white font-bold shadow-sm">JD</div>
                    <div className="w-9 h-9 rounded-full border-[2.5px] border-white bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-[11px] text-white font-bold shadow-sm">SA</div>
                    <div className="w-9 h-9 rounded-full border-[2.5px] border-white bg-gradient-to-br from-violet-400 to-violet-600 flex items-center justify-center text-[11px] text-white font-bold shadow-sm">MK</div>
                  </div>
                  <button className="bg-slate-900 hover:bg-slate-800 text-white text-[13px] font-bold px-5 py-2.5 rounded-xl shadow-lg shadow-slate-900/20 transition-all hover:-translate-y-0.5">
                    + Create task
                  </button>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-5 flex-1 relative">
                ...
                <div className="cursor-animated drop-shadow-lg z-50">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="#8b5cf6" xmlns="http://www.w3.org/2000/svg" className="rotate-[-15deg]">
                    <path d="M5.5 3.21V20.8c0 .45.54.67.85.35l4.86-4.86a.5.5 0 0 1 .35-.15h6.42c.45 0 .67-.54.35-.85L6.35 2.85a.5.5 0 0 0-.85.35Z" stroke="white" strokeWidth="2" strokeLinejoin="round"/>
                  </svg>
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex justify-between items-center px-1 mb-1">
                    <span className="text-[13px] font-bold text-slate-700 flex items-center gap-2">
                      <div className="w-2 h-2 bg-slate-400 rounded-full"></div> To Do
                    </span>
                    <span className="text-slate-300 hover:text-slate-500 cursor-pointer transition-colors text-lg leading-none">+</span>
                  </div>
                  ...
                  <div className="animate-drag bg-gradient-to-br from-[#EFF4FF] to-[#EEF2FF] rounded-2xl p-4 shadow-sm border border-indigo-100/50 hover:shadow-md transition-shadow cursor-grab active:cursor-grabbing">
                    <div className="flex gap-2 mb-3 flex-wrap">
                      <span className="text-[10px] font-bold bg-slate-50/80 text-indigo-600 px-2 py-1 rounded-lg border border-indigo-100/50 shadow-sm">#website</span>
                      <span className="text-[10px] font-bold bg-slate-50/80 text-indigo-600 px-2 py-1 rounded-lg border border-indigo-100/50 shadow-sm">#client</span>
                    </div>
                    <p className="text-[14px] font-bold text-indigo-950 leading-snug mb-4">Search inspirations for upcoming project</p>
                  ...
                  <div className="bg-gradient-to-br from-[#F5F0FF] to-[#FAF5FF] rounded-2xl p-4 shadow-sm border border-violet-100/50 hover:shadow-md transition-all hover:-translate-y-0.5">
                    <div className="flex gap-2 mb-3">
                      <span className="text-[10px] font-bold bg-slate-50/80 text-violet-600 px-2 py-1 rounded-lg border border-violet-100/50 shadow-sm">#mobile app</span>
                    </div>
                    <p className="text-[14px] font-bold text-violet-950 leading-snug mb-3">Ginko mobile app design</p>
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex justify-between items-center px-1 mb-1">
                    <span className="text-[13px] font-bold text-slate-700 flex items-center gap-2">
                      <div className="w-2 h-2 bg-amber-400 rounded-full animate-pulse"></div> In Progress
                    </span>
                    <span className="text-slate-300 hover:text-slate-500 cursor-pointer transition-colors text-lg leading-none">+</span>
                  </div>
                  ...
                  <div className="h-[150px] border-2 border-dashed border-slate-200 rounded-2xl bg-slate-50/50 flex items-center justify-center">
                    <span className="text-[11px] font-semibold text-slate-300">Drop tasks here</span>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-[#FFF7ED] to-[#FFFBF5] rounded-2xl p-4 shadow-sm border border-orange-100/50 hover:shadow-md transition-all hover:-translate-y-0.5">
                    <div className="flex gap-2 mb-3">
                      <span className="text-[10px] font-bold bg-slate-50/80 text-orange-600 px-2 py-1 rounded-lg border border-orange-100/50 shadow-sm">#dribbble shot</span>
                      <span className="text-[10px] font-bold bg-red-50 text-red-600 px-2 py-1 rounded-lg border border-red-100/50 shadow-sm">High</span>
                    </div>
                    <p className="text-[14px] font-bold text-orange-950 leading-snug mb-4">Wehiu product task and the task process pages</p>
                    <div className="flex items-center justify-between">
                      <div className="flex -space-x-1.5">
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex justify-between items-center px-1 mb-1">
                    <span className="text-[13px] font-bold text-slate-700 flex items-center gap-2">
                      <div className="w-2 h-2 bg-emerald-400 rounded-full"></div> Done
                    </span>
                    <span className="text-slate-300 hover:text-slate-500 cursor-pointer transition-colors text-lg leading-none">+</span>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-[#FDF2F8] to-[#FDF7FA] rounded-2xl p-4 shadow-sm border border-pink-100/50 hover:shadow-md transition-all hover:-translate-y-0.5 relative overflow-hidden">
                    ...
                    <div className="flex gap-2 mb-3">
                      <span className="text-[10px] font-bold bg-slate-50/80 text-pink-600 px-2 py-1 rounded-lg border border-pink-100/50 shadow-sm">#development</span>
                    </div>
                    <p className="text-[14px] font-bold text-pink-950 leading-snug mb-4 pr-6">Orypto product landing page create in webflow</p>
                  ...
                  <div className="bg-gradient-to-br from-[#ECFEFF] to-[#F0FDFF] rounded-2xl p-4 shadow-sm border border-cyan-100/50 hover:shadow-md transition-all hover:-translate-y-0.5">
                    <div className="flex gap-2 mb-3">
                      <span className="text-[10px] font-bold bg-slate-50/80 text-cyan-600 px-2 py-1 rounded-lg border border-cyan-100/50 shadow-sm">#mobile app</span>
                    </div>
                    <p className="text-[14px] font-bold text-cyan-950 leading-snug mb-3">Affitto product full service</p>
                    <div className="space-y-2 mb-3">
